...
namespace StudentCourseRegistrationSystem
{
    public partial class FormXemttcn : Form
    {
        ...
        private string maSv;
        public FormXemttcn(string maSv)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand(sql, conn))
                {
                    ...
                    using (SqlDataReader rd = cmd.ExecuteReader())
                    {
                        ...
                        txtGioiTinh.Text = rd["gioi_tinh"] == DBNull.Value ? "" : rd["gioi_tinh"].ToString();
                        txtEmail.Text = rd["email"] == DBNull.Value ? "" : rd["email"].ToString();
                        txtSDT.Text = rd["so_dien_thoai"] == DBNull.Value ? "" : rd["so_dien_thoai"].ToString();
                        txtDiaChi.Text = rd["dia_chi"] == DBNull.Value ? "" : rd["dia_chi"].ToString();

                        txtKhoaHoc.Text = rd["khoa_hoc"] == DBNull.Value ? "" : rd["khoa_hoc"].ToString();
                        txtTrangThai.Text = rd["trang_thai"] == DBNull.Value ? "" : rd["trang_thai"].ToString();

                        txtCTDT.Text = rd["ten_ctdt"] == DBNull.Value ? "" : rd["ten_ctdt"].ToString();
                        txtBacDaoTao.Text = rd["bac_dao_tao"] == DBNull.Value ? "" : rd["bac_dao_tao"].ToString();
                        txtKhoa.Text = rd["ten_khoa"] == DBNull.Value ? "" : rd["ten_khoa"].ToString();
                    }
                }
